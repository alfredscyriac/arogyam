      ...
      <div className='max-w-4xl mx-auto'>
        ...
        <div className='prose prose-lg max-w-none text-white space-y-8'>
          ...
          <section>
            ...
            <h3 className='text-xl font-light text-white mb-3'>Personal Information</h3>
            <ul className='list-disc pl-6 mb-6 space-y-2 font-light'>
              <li>Email address and account credentials</li>
              <li>Name</li>
            </ul>

            <h3 className='text-xl font-light text-white mb-3'>Health-Related Information</h3>
            <ul className='list-disc pl-6 mb-6 space-y-2 font-light'>
            ...
            <h3 className='text-xl font-light text-white mb-3'>Technical Information</h3>
            <ul className='list-disc pl-6 mb-6 space-y-2 font-light'>
          ...
          {/* Information Sharing */}
          <section>
            <h2 className='text-2xl font-medium text-white mb-4'>3. Information Sharing and Disclosure</h2>
            
            <h3 className='text-xl font-light text-white mb-3'>We DO NOT:</h3>
            <ul className='list-disc pl-6 mb-6 space-y-2 font-light'>
            ...
            <h3 className='text-xl font-light text-white mb-3'>We MAY share information:</h3>
            <ul className='list-disc pl-6 mb-6 space-y-2 font-light'>
          ...
          {/* Data Retention */}
          <section>
            <h2 className='text-2xl font-medium text-white mb-4'>5. Data Retention</h2>
            <ul className='list-disc pl-6 mb-6 space-y-2 font-light'>
          ...
          <section>
            <h2 className='text-2xl font-medium text-white mb-4'>6. Third-Party Services</h2>
            <p className='mb-4 font-light'>
          ...
          {/* Medical Disclaimer */}
          <section>
            <h2 className='text-2xl font-medium text-white mb-4'>7. Medical Disclaimer</h2>
            <div className='bg-yellow-50 border-l-4 border-yellow-400 p-6 mb-6'>
              <p className='font-regular text-black mb-2'>Important Health Notice:</p>
          ...
          {/* Changes to Policy */}
          <section>
            <h2 className='text-2xl font-medium text-white mb-4'>8. Changes to This Privacy Policy</h2>
            <p className='mb-6 font-light'>
