  ...
  return (
    <div className='h-[90vh] container mx-auto px-8 flex flex-col md:flex-row items-center justify-start md:justify-between md:pt-0 md:items-center'>
        ...
        <div className='w-full md:flex-1 text-white space-y-5 md:space-y-8 px-4 md:px-8 text-center md:text-left'>
            ...
            <button className="flex items-center justify-center font-semibold text-[19px] space-x-2 px-4 py-3 md:px-5 md:py-2 bg-secondarygreen md:bg-primarygreen hover:scale-105 rounded-lg transition-all duration-300 text-white cursor-pointer mx-auto md:mx-0">
